  ...
  <div class="ebook-slide-contents">
    ...
    <div class="slide-contents-book-wrapper" v-show="!searchVisible">
      ...
      <div class="slide-contents-book-info-wrapper">
        ...
        <div class="slide-contents-book-author">
          <span class="slide-contents-book-title-author-text">{{metadata.creator}}</span>
        </div>
      </div>
    ...
    <scroll class="slide-search-list" :top="66" :bottom="48" v-show="searchVisible">
      <div class="slide-search-item" v-for="(item, index) in searchList" :key="index"
           v-html="item.excerpt" @click="displayContent(item.cfi, true)">
      </div>
    </scroll>
  </div>
</template>
...
export default {
  ...
  methods: {
    doSearch (q) {
      ...
      ).then(results => Promise.resolve([].concat.apply([], results))) // 将多维数组转为一维数组
    },
    search () {
    ...
    contentItemStyle (item) {
      return {
        marginLeft: `${px2rem(item.level * 18)}rem`
      }
    }
  }
}
    ...
    .slide-contents-book-wrapper {
      ...
      .slide-contents-book-info-wrapper {
        ...
        .slide-contents-book-author{
          ...
          .slide-contents-book-title-author-text {
            @include ellipsis2(1)
          }
        }
      }
